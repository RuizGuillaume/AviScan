...
logger = setup_logger("DataCorrection", "DataCorrection.log")
...
class DatasetCorrection:
    ...
    def download_full_dataset(self):
        ...
        logger.info(f"Téléchargement du fichier csv contenant la liste des espèces ({link})")
        ...
        logger.info(f"Sauvegarde du fichier {self.db_to_clean}/birds_list.csv")
    ...
    def dataset_correction(self):
        ...
        logger.info("Correction du dataset et du fichier birds.csv")
